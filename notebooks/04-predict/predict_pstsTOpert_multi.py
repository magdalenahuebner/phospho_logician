...
# EDGES
enz_tprot = pd.read_csv('/Users/magdalena/Desktop/bezzlab/logic_things/results_lm/enz_tprot_dirts_AND_lm_MCF7.csv')
enz_sub = pd.read_csv('/Users/magdalena/Desktop/bezzlab/logic_things/results_lm/enz_sub_dirts_AND_lm_MCF7.csv')
# UNIVERSE
...
# export to csv with:
pred_perform.to_csv('/Users/magdalena/Desktop/bezzlab/logic_things/results_lm/pred_dirts_AND_lm_MCF7.csv', float_format='%.3f', index=False)
pk_pred_df.to_csv('/Users/magdalena/Desktop/bezzlab/logic_things/results_lm/pred_pk_dirts_AND_lm_MCF7.csv', float_format='%.3f', index=False)
