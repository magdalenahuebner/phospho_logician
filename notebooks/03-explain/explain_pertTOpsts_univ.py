...
# EDGES
enz_tprot = pd.read_csv('/Users/magdalena/Desktop/bezzlab/logic_things/facts_csv/lint_approach/dirts_tprot_MCF7_mp.csv')
enz_sub = pd.read_csv('/Users/magdalena/Desktop/bezzlab/logic_things/facts_csv/lint_approach/dirts_MCF7_mp.csv')
# OUTPUT
obs = pd.read_csv('/Users/magdalena/Desktop/bezzlab/logic_things/ctamdb_data/ctamdb_dpoa_MCF7.tsv', sep='\t')
# UNIVERSE
enz_sub_univ = pd.read_csv('/Users/magdalena/Desktop/bezzlab/logic_things/facts_csv/lint_approach/dirts_MCF7_mp.csv')
...
enz_sub_edges = np.array(enz_sub[['K', 'Pst']])
...
# export to csv with:
explainability.to_csv('/Users/magdalena/Desktop/bezzlab/logic_things/results_lm/expl_dirts_MCF7.csv', index=False)
